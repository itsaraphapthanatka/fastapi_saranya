...
class StandardSetDetail(Base):
    ...
    def __repr__(self):
        return f"<StandardSetDetail(id={self.id!r}, s_id={self.s_id!r}, s_set_id={self.s_set_id!r}, s_set_title={self.s_set_title!r}, s_set_desc={self.s_set_desc!r}, s_set_img={self.s_set_img!r}, s_set_chk_main={self.s_set_chk_main!r})>"
